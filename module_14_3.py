...
async def get_buying_list(message):
    with open('adrenaline.jpg', 'rb') as adr:
        await message.answer_photo(adr, 'Название: Адреналин | Описание: Симпатомиметик | Цена: 500', )
    with open('propofol.jpg', 'rb') as prop:
        await message.answer_photo(prop, 'Название: Пропофол | Описание: Наркозное средство | Цена: 1500', )
    with open('fenazepam.png', 'rb') as fen:
        await message.answer_photo(fen, 'Название: Феназепам | Описание: Анксиолитик | Цена: 750', )
    with open('galoperidol.jpeg', 'rb') as gal:
        await message.answer_photo(gal, 'Название: Галоперидол | Описание: Нейролептик | Цена: 2000', )
